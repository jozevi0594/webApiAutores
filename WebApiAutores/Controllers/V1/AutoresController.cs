...
namespace WebApiAutores.Controllers.V1
{
    ...
    //[ApiConventionType(typeof(DefaultApiConventions))]// documentar respuestas por default a nivel de controlador
    ...
    public class AutoresController : ControllerBase
    {
        ...
        [AllowAnonymous]
        [ServiceFilter(typeof(HATEOASAutorFilterAttribute))]//Filtro creado a medida para la visualizacion de enlaces
        [ProducesResponseType(404)]//documentar respuesta el error 404 a nivel de endpoint
